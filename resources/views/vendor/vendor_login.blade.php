                                        ...
                                        <form method="POST" class="row g-3" action="{{ route('login') }}">
											...
											<div class="col-12">
												...
												<div class="input-group" id="show_hide_password">
													<input type="password" name="password" class="form-control border-end-0" id="password" placeholder="Senha"> <a href="javascript:;" class="input-group-text bg-transparent"><i class='bx bx-hide'></i></a>
												</div>
											</div>
											<div class="col-md-6">
											...
											<div class="col-md-6 text-end">	<a href="authentication-forgot-password.html">Esqueceu sua senha ?</a>
											</div>
											<div class="col-12">
												<div class="d-grid">
