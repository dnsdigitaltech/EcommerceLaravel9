                        ...
                        <div class="card-body">
                            <form method="POST" action="{{route('inactive.vendor.approve')}}" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <textarea name="vendor_short_info" class="form-control" id="inputAddress" placeholder="Informações do fornecedor" rows="3">{{$activeVendorDetails->vendor_short_info}}</textarea>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-sm-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="submit" class="btn btn-danger px-4" value="Inativar Fornecedor" />
                                    </div>
                                </div>
                            </form>
                        </div>
