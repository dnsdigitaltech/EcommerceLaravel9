...
<div class="page-content"> 
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">Editar Categoria</div>
        <div class="ps-3">
                            ...
                            <form id="myForm" method="POST" action="{{route('update.category')}}" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <img id="showImage" src="{{ asset($category->category_image)}}" alt="categoria" style="width: 100px; height: 100px;">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="submit" class="btn btn-primary px-4" value="Adicionar categoria" />
                                    </div>
                                </div>
                            </form>
                        </div>
