                        ...
                        <div class="col-lg-8">
                            <div class="border border-3 p-4 rounded">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="product_name" class="form-control" id="inputProductTitle" value="{{$product->product_name}}" placeholder="Nome do produto">
                                </div>
                                <div class="form-group mb-3">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea name="long_description" id="long_description" class="form-control" rows="3">{!!$product->long_description!!}</textarea>
                                </div>
                               {{--- <div class="form-group mb-3">
                                ...
                                <div class="form-group mb-3">
                                    <label for="formFile" class="form-label">Multiplas imagens</label>
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="row g-3">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="selling_price" class="form-control" id="selling_price" value="{{$product->selling_price}}" placeholder="00.00">
                                    </div>
                                    <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="product_code" class="form-control" id="inputCostPerPrice" value="{{$product->product_code}}" placeholder="00.00">
                                    </div>
                                    <div class="form-group col-md-6">
    ...
    $(document).ready(function (){
        $('#myForm').validate({
            ...
            messages :{
                ...
                short_description: {
                    required : 'Informe uma decrição curta do produto',
                },
                product_thambnail: {
                    required : 'Informe a imagem do produto',
                },
                multi_img: {
                    required : 'Informe mais imagens do produto',
                },
                selling_price: {
                    required : 'Informe o preço do produto',
                },
                discount_price: {
                    required : 'Informe o desconto do produto',
                },
                product_code: {
                ...
                brand_id: {
                    required : 'Escolha a marca do produto',
                },
                ...
                subcategory_id: {
                    required : 'Escolha a subcategoria do produto',
                },
            },
            errorElement : 'span', 
